...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -294.5664571818506; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 1078.5909991683186; // x position of the perpendicular encoder (in tick units)
    }
